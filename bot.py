...
def start(message):
	markup = types.ReplyKeyboardMarkup(row_width=2, resize_keyboard=True)  # Создаем клавиатуру с шириной в 2 кнопки в ряду
	...
	markup.add(btn1, btn2, btn3, btn4, btn5, btn6)  # Добавляем кнопки в клавиатуру
